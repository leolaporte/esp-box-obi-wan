...
- **WiFi setup:** see [WIFI.md](WIFI.md) — **never commit credentials**.
- **Backend:** [leolaporte/obi-wan-core](https://github.com/leolaporte/obi-wan-core) — the `esp` channel listens on `:9090/talk`.

Upstream Espressif README follows.
